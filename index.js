...
// Your personal golden coin (you already uploaded it)
...
bot.start((ctx) => {
  ...
  ctx.replyWithPhoto(
    GOLDEN_COIN_FILE_ID,
    {
      caption: `Hi, *${name.replace(/([_*[\]()~`>#+=|{}.!-])/g, '\\$1')}*! This is YOURCOIN 👋\n\n` +
          ...
          [
            {
              ...
              web_app: { url: 'https://t.me/Notgames_tools_bot/app' }   // ← THIS WORKS NOW
            }
          ]
        ]
      }
...
// Graceful stop (very important on Render)
